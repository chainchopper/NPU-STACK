// Nirvana ILI9341 Driver — Waveshare 2.4" LCD (240x320)
// Ameba SDK: SPI.begin(TFT_CS) — registers only OUR SS pin, avoids pin 4 conflict
...
// Init: call AFTER pinMode on all LCD GPIO + SPI.begin(TFT_CS) in setup()
