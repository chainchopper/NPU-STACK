...
PLATFORMS = {
    ...
    "s3-matrix": {
        ...
        "families": ["esp32-s3", "waveshare-s3-matrix", "waveshare"],
        "agent_dir": "s3-matrix-agent",
        "main_file": "main.py",
        "flash": {
            "tool": "esptool",
            "firmware_url": "https://micropython.org/resources/firmware/ESP32_GENERIC_S3-20240602-v1.23.0.bin",
    ...
    "amb82-mini": {
        "name": "Ameba AMB82-Mini (RTL8735B)",
        "families": ["amb82", "ameba", "rtl8735b", "realtek"],
        ...
        "hardware": {
            "chip": "RTL8735B",
            "cpu": "Cortex-M33 @ 330MHz + NN engine",
            "flash_mb": 16,
            "sram_kb": 512,
            "psram_mb": 4,
            ...
            "display": "SPI ST7789 240x240",
            "audio": "I2S mic + speaker",
            "sd_card": "microSD (app storage)",
            "npu": "built-in NN engine (object detection, face recognition, keyword spotting)",
            "protocol": "xiaozhi-compatible MQTT+UDP hybrid",
        },
    },
    "nirvana-pocket": {
        "name": "Nirvana Pocket Assistant",
        "families": ["esp32-s3", "xiao-esp32s3-sense", "waveshare-s3-matrix", "amb82"],
        "agent_dir": "nirvana-pocket-assistant",
        "main_file": "main.py",
        "flash": {
            "tool": "esptool",
            "firmware_url": "https://micropython.org/resources/firmware/ESP32_GENERIC_S3-20240602-v1.23.0.bin",
