...
from routers.fleet_ota import router as fleet_ota_router
from routers.emulator import router as emulator_router
from routers.nirvana_audio import router as nirvana_audio_router
...
from services.xiaozhi_server import init_xiaozhi_server, shutdown_xiaozhi_server
...
async def lifespan(app: FastAPI):
    ...
    # ── Start XiaoZhi Voice Server (MQTT fleet voice protocol) ──
    try:
        if mqtt_status.get("started"):
            from services.xiaozhi_server import init_xiaozhi_server as _init_xz
            _ = _init_xz(
...
app.include_router(nirvana_audio_router)
