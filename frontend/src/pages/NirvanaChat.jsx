...
const WEBUI_URL = '/nirvana-webui/';  // Vite proxy to :8789 (same-origin, no CSP block)
      ...
      {error && (
        <div style={{ position: 'absolute', top: 38, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-primary)', zIndex: 5 }}>
          <div style={{ textAlign: 'center', maxWidth: 400 }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 16 }}>Make sure the NPU-STACK backend is running on port 8010</p>
